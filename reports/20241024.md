...
- Implement some of the visual structure of workouts tab
...
### Dominic (Frontend / Backend / QA)
- Continue on working on workout hierarchy
- Develop template creator
- Sort out issues with suggested vs saved templates
...
### Dominic (Frontend / Backend / QA)
- Have modifications to the workouts tab done 
- Learn the dependencies, and research documentation for backend and nativewind 
### Prayug (Frontend / Backend)
...
### Dominic (Frontend / Backend / QA)
- Progress
    - Made changes to the workouts tab
    - learned backend and added exercises and muscles
    - how the dependencies work, how to work with nativewind
- Issues
    - I haven't developed in typescript in a while, so i had to relearn a bunch
    - need to make the components function
...
- Issues
    - Optimizing re-renders with state updates
